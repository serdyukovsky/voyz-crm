...
export default function UsersSettingsPage() {
  ...
  const handleRoleUpdate = async (userId: string, newRole: UserRole) => {
    try {
      ...
      showError(t('users.updateError'), error instanceof Error ? error.message : 'Unknown error')
    }
  }
  ...
  const handleDeleteUser = async (userId: string) => {
    ...
    try {
      ...
      showError(t('users.deleteError'), error instanceof Error ? error.message : 'Unknown error')
    }
  }
