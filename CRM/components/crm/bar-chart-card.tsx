...
import type { TopManager } from '@/lib/api/stats'
  ...
  return (
    <Card className="border-border/50 bg-card gap-4">
      <CardHeader className="px-4 pt-4 pb-2">
        <CardTitle className="text-sm font-semibold text-foreground">{t('dashboard.topManagers')}</CardTitle>
        <p className="text-xs text-muted-foreground">{t('dashboard.topManagersDesc')}</p>
      </CardHeader>
